      ...
      <div class="offcanvas-body">
        ...
        <div class="price py-2">
          ...
          <div class="d-flex">
            <div class="d-flex align-items-center">
              ...
              <input class="form-control" placeholder="Min." name="min_price" id="min_price" type="number" min="1">
            </div>
            <div class="d-flex align-items-center">
              <label for="max_price"><i class="fa-solid fa-euro-sign"></i></label>
              <input class="form-control" placeholder="Max." name="max_price" id="max_price" type="number" min="1">
            </div>
          </div>
        </div>
        <!-- /price -->
        ...
        <div class="sqr-meters pb-2">
          ...
          <div class="d-flex align-items-center">
            ...
            <input class="form-control" placeholder="Metratura minima" name="sqr_meters" id="sqr_meters" type="number" min="1">
          </div>
        </div>
        <!-- /sqrmeters -->
        <!-- services -->
        ...
        <div class="details pb-2">
          <div class="rooms mb-3">
            <h5 class="fw-semibold mb-3">Stanze :</h5>
              <input type="radio" class="btn-check" name="rooms" id="rooms_1" autocomplete="off" checked>
              <label class="btn btn-check-label me-4" for="rooms_1">1</label>
              <input type="radio" class="btn-check" name="rooms" id="rooms_2" autocomplete="off">
              <label class="btn btn-check-label me-4" for="rooms_2">2</label>
              <input type="radio" class="btn-check" name="rooms" id="rooms_3" autocomplete="off">
              <label class="btn btn-check-label me-4" for="rooms_3">3</label>
              <input type="radio" class="btn-check" name="rooms" id="rooms_4" autocomplete="off">
              <label class="btn btn-check-label me-4" for="rooms_4">4</label>
              <input type="radio" class="btn-check" name="rooms" id="rooms_5" autocomplete="off">
              <label class="btn btn-check-label me-4" for="rooms_5">5</label>
              <input type="radio" class="btn-check" name="rooms" id="rooms_6" autocomplete="off">
              <label class="btn btn-check-label" for="rooms_6">6+</label>
          </div>
          <div class="beds mb-3">
            <h5 class="fw-semibold mb-3">Letti :</h5>
            <input type="radio" class="btn-check" name="beds" id="beds_1" autocomplete="off" checked>
            <label class="btn btn-check-label me-4" for="beds_1">1</label>
            <input type="radio" class="btn-check" name="beds" id="beds_2" autocomplete="off">
            <label class="btn btn-check-label me-4" for="beds_2">2</label>
            <input type="radio" class="btn-check" name="beds" id="beds_3" autocomplete="off">
            <label class="btn btn-check-label me-4" for="beds_3">3</label>
            <input type="radio" class="btn-check" name="beds" id="beds_4" autocomplete="off">
            <label class="btn btn-check-label me-4" for="beds_4">4</label>
            <input type="radio" class="btn-check" name="beds" id="beds_5" autocomplete="off">
            <label class="btn btn-check-label me-4" for="beds_5">5</label>
            <input type="radio" class="btn-check" name="beds" id="beds_6" autocomplete="off">
            <label class="btn btn-check-label" for="beds_6">6+</label>
          </div>
          <div class="bathrooms mb-3">
            <h5 class="fw-semibold mb-3">Bagni :</h5>
            <input type="radio" class="btn-check" name="bathrooms" id="bathrooms_1" autocomplete="off" checked>
              <label class="btn btn-check-label me-4" for="bathrooms_1">1</label>
              <input type="radio" class="btn-check" name="bathrooms" id="bathrooms_2" autocomplete="off">
              <label class="btn btn-check-label me-4" for="bathrooms_2">2</label>
              <input type="radio" class="btn-check" name="bathrooms" id="bathrooms_3" autocomplete="off">
              <label class="btn btn-check-label me-4" for="bathrooms_3">3</label>
              <input type="radio" class="btn-check" name="bathrooms" id="bathrooms_4" autocomplete="off">
              <label class="btn btn-check-label me-4" for="bathrooms_4">4</label>
              <input type="radio" class="btn-check" name="bathrooms" id="bathrooms_5" autocomplete="off">
              <label class="btn btn-check-label me-4" for="bathrooms_5">5</label>
              <input type="radio" class="btn-check" name="bathrooms" id="bathrooms_6" autocomplete="off">
        ...
        <div class="range pb-3">
          ...
          <div class="d-flex">
            <input type="range" class="form-range custom-range" min="0" max="5" step="1" value="0" id="customRange">
          </div>
