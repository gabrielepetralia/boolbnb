      ...
      <nav class="d-flex align-items-center">
        ...
        <ul class="d-flex align-items-center mb-0 h-100">
          ...
          <li class="header-menu-item">
            <router-link :to="{ name: 'apartments' }" class="nav-link fw-semibold">Gestisci Appartamenti</router-link>
          </li>
        </ul>
      </nav>

      <div>
        <button class="btn btn-login t4-btn d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#login-modal">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <button type="button" class="btn my-3 w-100 t4-btn">Sign In</button>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form @submit="prevent.handleRegistration()">
            ...
            <button type="submit" class="btn my-3 w-100 t4-btn">Sign Up</button>
          </form>
        </div>
        <div class="modal-footer d-flex justify-content-center">
